...
import com.jiawa.concert.business.service.BeforeConfirmOrderService;
...
public class ConfirmOrderController {
    ...
    public CommonResp<Integer> queryLineCount(@PathVariable Long id) {
        Integer count = beforeConfirmOrderService.queryLineCount(id);
        return new CommonResp<>(count);
    }

    @GetMapping("/cancel/{id}")
    public CommonResp<Integer> cancel(@PathVariable Long id) {
        Integer count = beforeConfirmOrderService.cancel(id);
        return new CommonResp<>(count);
    }
